<template>
    <div class="container mt-4">
        <el-form ref="formRef" :model="form" :rules="rules" label-position="top" size="medium" class="row g-3">
            <!-- Name -->
            ...
            <el-form-item label="Category" prop="category" class="col-12 col-lg-6">
                <el-select v-model="form.category" placeholder="Select category" clearable filterable class="w-100">
            ...
            <el-form-item label="Stock" prop="stock" class="col-12 col-lg-6">
                <el-input v-model.number="form.stock" type="number" min="0" placeholder="Enter stock" />
            </el-form-item>

            <!-- Rating -->
            <el-form-item label="Rating" prop="rating" class="col-12 col-lg-6">
                <el-input v-model.number="form.rating" type="number" min="0" max="5" step="0.1"
                    placeholder="Enter rating (0 - 5)" />
            </el-form-item>

            <!-- Price -->
            <el-form-item label="Price" prop="price" class="col-12 col-lg-6">
                <el-input v-model.number="form.price" type="number" min="0.01" step="0.01" placeholder="Enter price" />
            </el-form-item>

            <!-- Status -->
            <el-form-item label="Status" prop="status" class="col-12 col-lg-6">
                <el-select v-model="form.status" placeholder="Select status" clearable filterable class="w-100">
                    <el-option v-for="status in statusList" :key="status.key" :label="status.description"
                        :value="status.key" />
                </el-select>
            </el-form-item>
...
<script>
import { listCategory, listStatus, createProduct } from '@/service/ProductService';
